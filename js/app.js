/* ============================================
   Programming Academy - Main Application
   ============================================ */
...
const App = {
    ...
    init() {
        ...
        if (localStorage.getItem('programming-darkmode') === 'true') {
    ...
    loadProgress() {
        try {
            ...
            const savedQuiz = localStorage.getItem('programming-quiz-results');
    ...
    saveProgress() {
        localStorage.setItem('programming-progress', JSON.stringify(this.progress));
        localStorage.setItem('programming-quiz-results', JSON.stringify(this.quizResults));
    },
    ...
    showDashboard() {
        ...
        var html = '<div class="fade-in">' +
            ...
            '<h2>プログラミング Academy へようこそ</h2>' +
            '<p>ゼロからWebアプリが作れるようになるプログラミング学習プラットフォームです。</p>' +
            '</div>' +
    ...
    toggleDarkMode() {
        ...
        if (isDark) {
            ...
            localStorage.setItem('programming-darkmode', 'false');
        } else {
            document.documentElement.setAttribute('data-theme', 'dark');
            localStorage.setItem('programming-darkmode', 'true');
        }
    },
    ...
    resetProgress() {
        if (confirm('全ての学習進捗をリセットしますか？この操作は元に戻せません。')) {
            this.progress = {};
            this.quizResults = {};
            localStorage.removeItem('programming-progress');
            localStorage.removeItem('programming-quiz-results');
            this.buildSidebar();
            this.updateGlobalProgress();
            this.showDashboard();
        }
